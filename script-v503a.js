window.JAHNTELLA_BUILD = "5.0.3A-PREMIUM-PACK-ANIMATION";
...
function resetPackAnimationClasses() {
  packStage?.classList.remove("phase-charge", "phase-burst", "phase-card-rise", "phase-card-flip", "phase-complete");
  sweetPack?.classList.remove("is-charging", "is-opening");
  cardRevealPanel?.classList.remove("is-entering", "is-revealed");
  featuredSweetCard?.classList.remove("reveal-pop");
}
...
function openPack() {
  ...
  schedulePackStep(() => {
    ...
    packStage.classList.add("phase-burst");
  ...
  schedulePackStep(() => {
    packStage.classList.remove("phase-card-flip");
