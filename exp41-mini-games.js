...
(() => {
'use strict';
const pathFile=(location.pathname.split('/').pop()||'').toLowerCase();
const district=(new URLSearchParams(location.search).get('district')||'').toLowerCase();
const p=pathFile==='living-world.html'&&district?`${district}.html`:pathFile;
const pages=new Set([
...
if(!document.querySelector('link[href*="exp41-mini-games.css"]')){const l=document.createElement('link');l.rel='stylesheet';l.href='exp41-mini-games.css?v=41.1';document.head.appendChild(l)}
if(!document.querySelector('script[src*="exp41-mini-games.js"]')){const s=document.createElement('script');s.src='exp41-mini-games.js?v=41.1';s.defer=true;document.body.appendChild(s)}
})();
